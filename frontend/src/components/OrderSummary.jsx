...
const stripePromise = loadStripe(
  "pk_test_51PtaUZHYBDlNWhVMIFw3RnNZKLdBmbZCvBzl1sv262NwA2S6O5nn6tohnB1Pu9hEyeqiCWpfvboJ0iPJFTtaOQ9k00B6ke0z9u"
);
    ...
    >
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-center gap-2">
          ...
          <Link
            to="/"
            className="inline-flex items-center gap-2 text-sm font-medium text-gray-900 underline hover:text-gray-700 hover:no-underline"
          >
            Continue Shopping
            <MoveRight size={16} />
          </Link>
